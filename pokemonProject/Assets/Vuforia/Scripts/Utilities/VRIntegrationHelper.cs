    ...
    void LateUpdate()
    {
        ...
        if (IsLeft)
        {
            if (mLeftCameraDataAcquired && mRightCameraDataAcquired)
            {
                ...
                // mLeftCamera.SetStereoProjectionMatrix(mLeftCamera.projectionMatrix, mRightCamera.projectionMatrix);
                // mRightCamera.SetStereoProjectionMatrix(mLeftCamera.projectionMatrix, mRightCamera.projectionMatrix);
